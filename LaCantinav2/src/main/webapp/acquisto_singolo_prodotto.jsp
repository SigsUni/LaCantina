...
<div class = "card-header text-center">
	...
	<div class= "form-group">
			...
			<input type = "text" class = "form-control" name = "insert-quantity" value ="<%=request.getParameter("quantity") %>"  required readonly>
			
			<label>Prezzo</label>
			<input type = "text" class = "form-control" name = "insert-prezzo" value ="<%=request.getParameter("prezzo") %>"  required readonly>
