                ...
                <table class="custom-table">
                    ...
                    <tbody>
                        ...
                        for(Carrello c : cart_list) { 
                            // Controllo di sicurezza: se il prodotto è null, saltiamo la riga
                            if(c.getProdotto() == null) continue;
                        %>
                        <tr>
